class PlantStage:
    ...
    def desired_water_amt(self):
        ...
        max_water = self.plant.l_effect * (self.plant.num_sunlight_points ** 0.5)
        return max_water
...
class GrowthStage(PlantStage):
    ...
    def amount_to_grow(self):
        G = self.plant.w_effect * self.plant.water_amt
    ...
    def __str__(self):
        return f"{super().__str__()}: w_effect={self.plant.w_effect}, l_effect={self.plant.l_effect}, k1={self.plant.k1}, k2={self.plant.k2}"
